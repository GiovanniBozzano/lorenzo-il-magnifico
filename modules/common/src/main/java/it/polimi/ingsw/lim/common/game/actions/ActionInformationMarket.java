...
public class ActionInformationMarket extends ActionInformation
{
	private final FamilyMemberType familyMemberType;
	private final int servants;
	private final MarketSlot marketSlot;

	public ActionInformationMarket(FamilyMemberType familyMemberType, int servants, MarketSlot marketSlot)
	{
