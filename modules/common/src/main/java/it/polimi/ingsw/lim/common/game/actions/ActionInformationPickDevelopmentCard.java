...
public class ActionInformationPickDevelopmentCard extends ActionInformation
{
	...
	public ActionInformationPickDevelopmentCard(FamilyMemberType familyMemberType, int servants, CardType cardType, Row row, List<ResourceAmount> discountChoice, ResourceCostOption resourceCostOption)
	{
