...
public class ActionInformationChooseRewardPickDevelopmentCard extends ActionInformation
{
	...
	public ActionInformationChooseRewardPickDevelopmentCard(int servants, CardType cardType, Row row, Row instantRewardRow, List<ResourceAmount> instantDiscountChoice, List<ResourceAmount> discountChoice, ResourceCostOption resourceCostOption)
	{
