...
{
	CONDOTTIERO("BLUE_CARD_1_1", Period.FIRST, 2, new Reward(new Event[] {}, new ResourceAmount[] { new ResourceAmount(Resource.MILITARY_POINT, 3) }), new BonusAdditionCard(2, CardType.GREEN, new ResourceAmount[][] {})),
	COSTRUTTORE("BLUE_CARD_1_2", Period.FIRST, 4, new Reward(new Event[] {}, new ResourceAmount[] {}), new BonusAdditionCard(2, CardType.YELLOW, new ResourceAmount[][] { { new ResourceAmount(Resource.WOOD, 1) }, { new ResourceAmount(Resource.STONE, 1) } })),
	DAMA("BLUE_CARD_1_3", Period.FIRST, 4, new Reward(new Event[] {}, new ResourceAmount[] {}), new BonusAdditionCard(2, CardType.BLUE, new ResourceAmount[][] { { new ResourceAmount(Resource.COIN, 1) } })),
	CAVALIERE("BLUE_CARD_1_4", Period.FIRST, 2, new Reward(new Event[] {}, new ResourceAmount[] { new ResourceAmount(Resource.COUNCIL_PRIVILEGE, 1) }), new BonusAdditionCard(2, CardType.PURPLE, new ResourceAmount[][] {})),
	...
	BADESSA("BLUE_CARD_1_8", Period.FIRST, 3, new Reward(new Event[] { new EventCard(4, new CardType[] { CardType.BLUE, CardType.GREEN, CardType.PURPLE, CardType.YELLOW }, new ResourceAmount[][] {}) }, new ResourceAmount[] { new ResourceAmount(Resource.FAITH_POINT, 1) }), null),
	CAPITANO("BLUE_CARD_2_1", Period.SECOND, 4, new Reward(new Event[] { new EventCard(6, new CardType[] { CardType.GREEN }, new ResourceAmount[][] {}) }, new ResourceAmount[] { new ResourceAmount(Resource.MILITARY_POINT, 2) }), null),
	ARCHITETTO("BLUE_CARD_2_2", Period.SECOND, 4, new Reward(new Event[] { new EventCard(6, new CardType[] { CardType.YELLOW }, new ResourceAmount[][] { { new ResourceAmount(Resource.WOOD, 1), new ResourceAmount(Resource.STONE, 1) } }) }, new ResourceAmount[] {}), null),
	MECENATE("BLUE_CARD_2_3", Period.SECOND, 3, new Reward(new Event[] { new EventCard(6, new CardType[] { CardType.BLUE }, new ResourceAmount[][] { { new ResourceAmount(Resource.COIN, 2) } }) }, new ResourceAmount[] {}), null),
	EROE("BLUE_CARD_2_4", Period.SECOND, 4, new Reward(new Event[] { new EventCard(6, new CardType[] { CardType.PURPLE }, new ResourceAmount[][] {}) }, new ResourceAmount[] { new ResourceAmount(Resource.COUNCIL_PRIVILEGE, 1) }), null),
	...
	AMBASCIATORE("BLUE_CARD_3_8", Period.THIRD, 6, new Reward(new Event[] { new EventCard(7, new CardType[] { CardType.BLUE, CardType.GREEN, CardType.PURPLE, CardType.YELLOW }, new ResourceAmount[][] {}) }, new ResourceAmount[] { new ResourceAmount(Resource.COUNCIL_PRIVILEGE, 1) }), null);
