...
public enum CardBlue
{
	...
	CAPITANO("BLUE_CARD_2_1", Period.FIRST, 4, new Reward(new Event[] { new EventCard(6, new CardType[] { CardType.GREEN }, new ResourceAmount[][] {}) }, new ResourceAmount[] { new ResourceAmount(Resource.MILITARY_POINT, 2) }), null),
