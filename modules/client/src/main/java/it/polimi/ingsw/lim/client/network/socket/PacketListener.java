...
class PacketListener extends Thread
{
	...
	static {
		...
		PacketListener.PACKET_HANDLERS.put(PacketType.GAME_PERSONAL_BONUS_TILE_CHOSEN, packet -> Client.getInstance().getConnectionHandler().handleGamePersonalBonusTileChosen());
