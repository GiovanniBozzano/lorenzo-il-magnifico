...
class PacketListener extends Thread
{
	...
	static {
		...
		PacketListener.PACKET_HANDLERS.put(PacketType.GAME_LEADER_CARD_CHOSEN, packet -> Client.getInstance().getConnectionHandler().handleGameLeaderCardChosen(((PacketGameLeaderCardChosen) packet).getChoicePlayerIndex()));
