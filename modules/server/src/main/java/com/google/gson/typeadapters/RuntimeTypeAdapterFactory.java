 ...
 * If you don't supply an explicit type
 ...
 * }</pre>
 */
@SuppressWarnings("squid:S1188") public final class RuntimeTypeAdapterFactory<T> implements TypeAdapterFactory
{
	...
	/**
	 * Creates a new runtime type adapter for {@code baseType} using {@code
