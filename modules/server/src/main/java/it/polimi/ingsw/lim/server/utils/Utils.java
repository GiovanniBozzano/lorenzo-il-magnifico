...
public class Utils
{
	...
	static {
		...
		Utils.ACTIONS_TRANSFORMERS.put(ActionType.LEADER_PLAY, (actionInformations, player) -> new ActionLeaderPlay(((ActionInformationsLeaderPlay) actionInformations).getLeaderCardIndex(), ((ActionInformationsLeaderPlay) actionInformations).getLeaderCardConditionsOption(), player));
