...
public class Authentication extends UnicastRemoteObject implements IAuthentication
{
	...
	private AuthenticationInformation finalizeAuthentication(String username, RoomType roomType, IServerSession serverSession) throws RemoteException, AuthenticationFailedException
	{
		...
		try {
			...
			if (playerRoom.isEndGame()) {
				authenticationInformation = this.handleNormalAuthentication(username, roomType, serverSession, authenticationInformation);
			} else {
				authenticationInformation = this.handleGameStartedAuthentication(username, serverSession, playerRoom, authenticationInformation);
			}
	...
	private AuthenticationInformationLobbyRMI handleNormalAuthentication(String username, RoomType roomType, IServerSession serverSession, AuthenticationInformation authenticationInformation) throws RemoteException
	{
	...
	private AuthenticationInformationGameRMI handleGameStartedAuthentication(String username, IServerSession serverSession, Room playerRoom, AuthenticationInformation authenticationInformation) throws RemoteException, AuthenticationFailedException
	{
