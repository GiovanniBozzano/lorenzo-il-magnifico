...
public enum QueryWrite
{
	...
	UPDATE_PLAYER_VICTORY_POINTS_RECORD("UPDATE " + Database.PREFIX + Database.TABLE_PLAYERS + " SET " + Database.TABLE_PLAYERS_COLUMN_VICTORY_POINTS_RECORD + " = ? WHERE " + Database.TABLE_PLAYERS_COLUMN_USERNAME + " = ?;"),
	UPDATE_GOOD_GAMES("UPDATE " + Database.PREFIX + Database.TABLE_PLAYERS + " SET " + Database.TABLE_PLAYERS_COLUMN_GOOD_GAMES + " = " + Database.TABLE_PLAYERS_COLUMN_GOOD_GAMES + " + 1 WHERE " + Database.TABLE_PLAYERS_COLUMN_USERNAME + " = ?;");
