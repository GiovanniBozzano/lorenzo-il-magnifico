...
{
	EXCOMMUNICATION_TILES_1_1(0, "/images/excommunication_tiles/.png", new Modifier<EventGainResources>(EventGainResources.class, "Each time you gain Military Points (from action spaces or from your Cards), gain 1 fewer Military Point. (If you have more Cards that give you Military Points, consider each Card a single source, so you gain -1 Military Point for each card).")
	{
		@Override
	...
	EXCOMMUNICATION_TILES_2_1(7, "/images/excommunication_tiles/.png", new Modifier<EventGetDevelopmentCard>(EventGetDevelopmentCard.class, "Each time you take a Territory\nCard (through the action space or as\na Card effect), your action receives\na -4 reduction of its value.\nYou may still spend servants to\nincrease the action value and you\nmust apply your Card’s effects.")
	{
		@Override
	...
	EXCOMMUNICATION_TILES_2_2(8, "/images/excommunication_tiles/.png", new Modifier<EventGetDevelopmentCard>(EventGetDevelopmentCard.class, "Each time you take a Building\nCard (through the action space or as\na Card effect), your action receives\na reduction of -4 of its value.\nYou may still spend servants to\nincrease the action value and you\nmust apply your Card’s effects.")
	{
		@Override
		public void apply(EventGetDevelopmentCard event)
		{
	...
	EXCOMMUNICATION_TILES_2_3(9, "/images/excommunication_tiles/.png", new Modifier<EventGetDevelopmentCard>(EventGetDevelopmentCard.class, "Each time you take a Character\nCard (through the action space or as\na Card effect), your action receives\na -4 reduction of its value.\nYou may still spend servants to\nincrease the action value,and you\nmust apply your Card’s effects.")
	{
		@Override
		public void apply(EventGetDevelopmentCard event)
		{
	...
	EXCOMMUNICATION_TILES_2_4(10, "/images/excommunication_tiles/.png", new Modifier<EventGetDevelopmentCard>(EventGetDevelopmentCard.class, "Each time you take a Venture\nCard (through the action space or as\na Card effect), your action receives\na -4 reduction of its value.\nYou may still spend servants to\nincrease the action value and you\nmust apply your Card’s effects.")
	{
		@Override
		public void apply(EventGetDevelopmentCard event)
		{
	...
	EXCOMMUNICATION_TILES_2_5(11, "/images/excommunication_tiles/.png", new Modifier<EventPlaceFamilyMember>(EventPlaceFamilyMember.class, "You can’t place your Family\nMembers in the Market action\nspaces.")
	{
		@Override
		public void apply(EventPlaceFamilyMember event)
		{
	...
	EXCOMMUNICATION_TILES_2_6(12, "/images/excommunication_tiles/.png", new Modifier<EventUseServants>(EventUseServants.class, "You have to spend 2 servants to\nincrease your action value by 1\n(and 4 servants to increase it by 2,\nand so on...).")
	{
		@Override
	...
	EXCOMMUNICATION_TILES_3_1(14, "/images/excommunication_tiles/.png", new Modifier<EventVictoryPointsCalculation>(EventVictoryPointsCalculation.class, "At the end of the game, you\ndon’t score points for any of your\nInfluenced Characters.")
	{
		@Override
	...
	EXCOMMUNICATION_TILES_3_2(15, "/images/excommunication_tiles/.png", new Modifier<EventVictoryPointsCalculation>(EventVictoryPointsCalculation.class, "At the end of the game, you\ndon’t score points for any of your\nEncouraged Ventures.")
	{
		@Override
		public void apply(EventVictoryPointsCalculation event)
		{
	...
	EXCOMMUNICATION_TILES_3_3(16, "/images/excommunication_tiles/.png", new Modifier<EventVictoryPointsCalculation>(EventVictoryPointsCalculation.class, "At the end of the game, you\ndon’t score points for any of your\nConquered Territories.\n")
	{
		@Override
		public void apply(EventVictoryPointsCalculation event)
		{
	...
	EXCOMMUNICATION_TILES_3_4(17, "/images/excommunication_tiles/.png", new Modifier<EventPreVictoryPointsCalculation>(EventPreVictoryPointsCalculation.class, "At the end of the game, before\nthe Final Scoring, you lose\n1 Victory Point for every\n5 Victory Points you have. (For\nexample, if you have 26 Victory\nPoints before the Final Scoring, you\nlose 5 Victory Points.")
	{
		@Override
	...
	EXCOMMUNICATION_TILES_3_5(18, "/images/excommunication_tiles/.png", new Modifier<EventPostVictoryPointsCalculation>(EventPostVictoryPointsCalculation.class, "At the end of the game, you lose\n1 Victory Point for every Military\nPoint you have. (For example, if\nyou end the game with 12 Military\nPoints, you lose 12 Victory Points.)")
	{
		@Override
	...
	EXCOMMUNICATION_TILES_3_6(19, "/images/excommunication_tiles/.png", new Modifier<EventPostVictoryPointsCalculation>(EventPostVictoryPointsCalculation.class, "At the end of the game, you lose\n1 Victory Point for every wood\nand stone on your Building\nCards’ costs. (For example, if all\nyour Building Cards cost 7 wood\nand 6 stone, you lose 13 Victory\nPoints.)")
	{
		@Override
		public void apply(EventPostVictoryPointsCalculation event)
		{
	...
	ExcommunicationTile(int index, String texturePath, Modifier modifier)
	{
		this.index = index;
