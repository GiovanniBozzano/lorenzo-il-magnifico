...
public class CardsHandler
{
	...
	static {
		...
		CardsHandler.LEADER_CARDS.add(new LeaderCardModifier(16, "/images/leader_cards/leader_card_16.png", "Cesare Borgia", "Cesarem Borgiam, qui sanguinario ingenio, immanique saevitia veteres tyrannos\naequasse censeri potest, viroso sanguine, execrabile semine progenitum ferunt.", new ArrayList<>(Collections.singletonList(new LeaderCardConditionsOption(new ArrayList<>(Collections.singletonList(new CardAmount(CardType.BUILDING, 3))), new ArrayList<>(Arrays.asList(new ResourceAmount(ResourceType.COIN, 12), new ResourceAmount(ResourceType.FAITH_POINT, 2)))))), new Modifier<EventGetDevelopmentCard>(EventGetDevelopmentCard.class, "You don’t need to satisfy the Military Points requirement when\nyou take Territory Cards.")
		{
			@Override
			public void apply(EventGetDevelopmentCard event)
			{
		...
		CardsHandler.LEADER_CARDS.add(new LeaderCardReward(18, "/images/leader_cards/leader_card_18.png", "Cosimo de' Medici", "Debebunt igitur Medici magno Cosmo omnis Medicea, et Florentina posteritas.", new ArrayList<>(Collections.singletonList(new LeaderCardConditionsOption(new ArrayList<>(Arrays.asList(new CardAmount(CardType.BUILDING, 4), new CardAmount(CardType.CHARACTER, 2))), new ArrayList<>()))), new Reward(null, new ArrayList<>(Arrays.asList(new ResourceAmount(ResourceType.SERVANT, 3), new ResourceAmount(ResourceType.VICTORY_POINT, 1))))));
		CardsHandler.LEADER_CARDS.add(new LeaderCardReward(19, "/images/leader_cards/leader_card_19.png", "Bartolomeo Colleoni", "Et era allhor frequente per le bocche del volgo un sì fatto motto: «Havere il Coglione\nallo Sforza, il gioco di maniera in man concio, che non facendo ei torto alle carte più\nnon potea perdere».", new ArrayList<>(Collections.singletonList(new LeaderCardConditionsOption(new ArrayList<>(Arrays.asList(new CardAmount(CardType.TERRITORY, 4), new CardAmount(CardType.VENTURE, 2))), new ArrayList<>()))), new Reward(null, new ArrayList<>(Collections.singletonList(new ResourceAmount(ResourceType.VICTORY_POINT, 4))))));
	}
